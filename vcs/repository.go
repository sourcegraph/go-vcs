...
type MockRepository struct {
	ResolveRevision_ func(spec string) (CommitID, error)
	ResolveTag_      func(name string) (CommitID, error)
	ResolveBranch_   func(name string) (CommitID, error)

	GetCommit_ func(CommitID) (*Commit, error)
	CommitLog_ func(to CommitID) ([]*Commit, error)

	FileSystem_ func(at CommitID) (FileSystem, error)
}

var _ Repository = MockRepository{}

func (r MockRepository) ResolveRevision(spec string) (CommitID, error) {
...
func (r MockRepository) ResolveTag(name string) (CommitID, error) {
...
func (r MockRepository) ResolveBranch(name string) (CommitID, error) {
...
func (r MockRepository) GetCommit(id CommitID) (*Commit, error) {
	if r.GetCommit_ == nil {
		return nil, nil
	}
...
func (r MockRepository) CommitLog(to CommitID) ([]*Commit, error) {
	if r.CommitLog_ == nil {
		return nil, nil
	}
...
func (r MockRepository) FileSystem(at CommitID) (FileSystem, error) {
